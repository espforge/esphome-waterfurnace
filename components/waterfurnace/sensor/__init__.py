...
SENSOR_TYPES = {
    ...
    CONF_DISCHARGE_PRESSURE: (1115, "signed_tenths", False),
    CONF_SUCTION_PRESSURE: (1116, "signed_tenths", False),
    CONF_LOOP_PRESSURE: (1119, "signed_tenths", False),
    CONF_WATERFLOW: (1117, "signed_tenths", False),
